...
const BookingForm = ({ formData, handleChange, handleSubmit, loading }) => {
  const inputStyle = {
    padding: '0.9rem',
    borderRadius: '8px',
    ...
    <>
      ...
      <div style={{ fontFamily: 'Segoe UI, sans-serif', backgroundColor: '#f4f6f8', minHeight: '100vh' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ marginTop: '1rem', fontSize: '1.2rem', maxWidth: '90%' }}>
              Safe, reliable, and available on-demand. Whether it’s daily commute, events, or urgent travel — we’ve got you covered.
            </p>
          ...
          <div
            ...
            style={{
              position: 'relative',
              margin: isMobile ? '1rem auto' : '2rem',
              zIndex: 2,
              marginBottom: '2rem',
        ...
        <motion.section
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          style={{ backgroundColor: '#fff', padding: '3rem 1.5rem' }}
        >
          <div style={{
            maxWidth: '1100px',
            margin: '0 auto',
