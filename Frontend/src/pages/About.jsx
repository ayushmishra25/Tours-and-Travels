    ...
    <div className="wrapper-about">
      ...
      <div className="page-content-about">
        <section className="about-about">
          ...
          {/* Founding Philosophy */}
          <div className="philosophy-about">
            <h3>Our Founding Philosophy: The Art of Effortless Journeys and the Power of Shared Purpose</h3>
            <p>
              At Sahyog Force, we believe life’s grand narratives aren’t just built on monumental leaps, but on the countless smooth transitions in between. Our journey began not in a sterile boardroom, but perhaps during a particularly exasperating Delhi traffic jam – a quintessential urban crucible we’ve all, unfortunately, intimately experienced. It was in that very moment of chaotic frustration that a simple, yet profoundly impactful, idea took root:
            </p>
            <p>
              What if travel wasn’t a chore to be endured, a gauntlet to be run, but a seamless, stress‑free chapter in your day?
            </p>
            <p>
              Our philosophy is beautifully simple, yet meticulously executed: we handle the sticky bits, the myriad logistical complexities, so you can channel your precious energy towards what truly matters. We are the silent symphony conductor of your daily commute, the invisible guardian of your punctuality, and the relentless purveyor of pristine, predictable paths.
            </p>
            <p>
              For us, true luxury transcends plush leather seats; it resides in the unseen gears of unflinching reliability, the unwavering, almost instinctual commitment to your absolute safety, and the genuine, reassuring smile of a driver who’s truly got your back. We meticulously built Sahyog Force on the bedrock belief that every journey, irrespective of its duration or destination, deserves to be effortlessly elevated from mundane necessity to a memorable, even delightful, glide. It’s less about merely reaching your destination and everything about the serene, assured passage there.
            </p>
            <p><strong>Here, our name itself tells a story:</strong></p>
            <ul>
              <li><strong>'Sahyog' (सहयोग):</strong> The Essence of Collaboration and Shared Prosperity. Collaboration, cooperation, and a shared purpose — you’re never alone in navigating the city.</li>
              <li><strong>'Force':</strong> The Power of Precision, Professionalism, and Positive Impact. It’s the disciplined, well‑oiled machinery working tirelessly to create effortless experiences.</li>
            </ul>
            <p>
              Together, “Sahyog Force” encapsulates our holistic approach: a cooperative partnership empowered by a formidable commitment to excellence, delivering not just a ride, but a superior travel experience built on trust and seamless execution.
            </p>
          </div>

          {/* About Intro */}
          <h2 className="about-title-about">About Sahyog Force</h2>
          ...
          <p className="about-text-about">We’re not just delivering services — we’re delivering peace of mind.</p>

          {/* Mission & Vision Cards */}
          <div className="card-container-about">
            <div className="card-about">
              <div className="card-icon-about">🎯</div>
              <h4 className="card-title-about">Our Mission</h4>
            ...
            <div className="card-about">
              <div className="card-icon-about">🚀</div>
              <h4 className="card-title-about">Our Vision</h4>
              <p className="card-text-about">
          ...
          {/* Core Services */}
          <h3 className="section-title-about">Our Core Services</h3>
          <div className="card-container-about">
            <div className="card-about">
              <div className="card-icon-about">🧑‍✈️</div>
              <h4 className="card-title-about">Driver Services</h4>
              <ul className="card-list-about">
            ...
            <div className="card-about">
              <div className="card-icon-about">🏡</div>
              <h4 className="card-title-about">Upcoming: Home Help</h4>
              <ul className="card-list-about">
            ...
            <div className="card-about">
              <div className="card-icon-about">🛡️</div>
              <h4 className="card-title-about">Upcoming: Specialized Assistance</h4>
              <ul className="card-list-about">
          ...
          {/* Driver Verification */}
          <h3 className="section-title-about">Ironclad Driver Verification Process</h3>
          ...
          {/* Why Choose */}
          <h3 className="section-title-about">Why Choose Sahyog Force?</h3>
          <div className="card-container-about">
            <div className="card-about">
              <div className="card-icon-about">✅</div>
              <h4 className="card-title-about">Vetted Professionals</h4>
              <p className="card-text-about">Only the most skilled and courteous drivers make the cut.</p>
            </div>

            <div className="card-about">
              <div className="card-icon-about">💰</div>
              <h4 className="card-title-about">Transparent Pricing</h4>
              <p className="card-text-about">No surprises — everything is clear and upfront.</p>
            </div>

            <div className="card-about">
              <div className="card-icon-about">📞</div>
              <h4 className="card-title-about">24/7 Support</h4>
              <p className="card-text-about">Reach a real person anytime you need help.</p>
            </div>

            <div className="card-about">
              <div className="card-icon-about">📅</div>
              <h4 className="card-title-about">Flexible Booking</h4>
              <p className="card-text-about">From urgent rides to long-term assignments — we've got you.</p>
            </div>
          </div>
